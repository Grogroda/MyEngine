...
* bin/: Binary files, organized in subdirectories if needed (ignored by .gitignore);
...
* examples/: Examples of running scripts and their results (ignored by .gitignore).
